...
const DashboardScreen = ({ navigation }) => {
        ...
        const ActionButtons = () => (
                <View style={styles.actionButtons}>
                        ...
                        >
                                ...
                                >
                                        <Ionicons name="water" size={24} color="white" />
                                        <Text style={styles.buttonText}>Water Tracking</Text>
                                </LinearGradient>
                        </TouchableOpacity>
                </View>
        );
        ...
        const QuickStats = () => {
                ...
                const latestWeight = state.weightData.length > 0 ? state.weightData[state.weightData.length - 1].weight : null;
                                ...
                                <View style={styles.statsGrid}>
                                        ...
                                        <View style={styles.statItem}>
                                                ...
                                                <Text style={styles.statLabel}>Status</Text>
                                                                                    ...
                                                                                    <View style={styles.statItem}>
                                                    <Text style={styles.statNumber}>{todayWater.toFixed(0)}oz</Text>
                                        ...
                                        <View style={styles.statItem}>
                                                <Text style={styles.statNumber}>{state.weightData.length}</Text>
                                                <Text style={styles.statLabel}>Weight Entries</Text>
                                        </View>
                                </View>
                        </View>
                );
